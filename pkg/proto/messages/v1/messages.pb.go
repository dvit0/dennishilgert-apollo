...
func (x *FunctionPackageCreationMessage) GetRuntimeName() string {
	if x != nil {
...
func (x *FunctionPackageCreationMessage) GetRuntimeVersion() string {
	if x != nil {
...
func (x *FunctionPackageCreationMessage) GetRuntimeArchitecture() string {
	if x != nil {
...
var file_apollo_proto_messages_v1_messages_proto_rawDesc = []byte{
	...
	0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x22, 0xe1, 0x01, 0x0a, 0x1e, 0x46, 0x75, 0x6e,
	...
	0x65, 0x63, 0x73, 0x52, 0x08, 0x66, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x21, 0x0a,
	0x0c, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x03, 0x20,
	...
	0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x72, 0x75, 0x6e, 0x74, 0x69,
	0x6d, 0x65, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x31, 0x0a, 0x14, 0x72, 0x75, 0x6e,
	0x74, 0x69, 0x6d, 0x65, 0x5f, 0x61, 0x72, 0x63, 0x68, 0x69, 0x74, 0x65, 0x63, 0x74, 0x75, 0x72,
	0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x13, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65,
	0x41, 0x72, 0x63, 0x68, 0x69, 0x74, 0x65, 0x63, 0x74, 0x75, 0x72, 0x65, 0x22, 0xa1, 0x01, 0x0a,
...
var file_apollo_proto_messages_v1_messages_proto_goTypes = []interface{}{
	...
	(v11.FunctionStatus)(0),                 // 7: apollo.proto.frontend.v1.FunctionStatus
	(v12.InstanceType)(0),                   // 8: apollo.proto.registry.v1.InstanceType
	(*v12.ServiceInstanceMetrics)(nil),      // 9: apollo.proto.registry.v1.ServiceInstanceMetrics
	(*v12.WorkerInstanceMetrics)(nil),       // 10: apollo.proto.registry.v1.WorkerInstanceMetrics
}
var file_apollo_proto_messages_v1_messages_proto_depIdxs = []int32{
	...
	6,  // 3: apollo.proto.messages.v1.FunctionStatusUpdateMessage.function:type_name -> apollo.proto.fleet.v1.FunctionSpecs
	7,  // 4: apollo.proto.messages.v1.FunctionStatusUpdateMessage.status:type_name -> apollo.proto.frontend.v1.FunctionStatus
	8,  // 5: apollo.proto.messages.v1.InstanceHeartbeatMessage.instance_type:type_name -> apollo.proto.registry.v1.InstanceType
	9,  // 6: apollo.proto.messages.v1.InstanceHeartbeatMessage.service_instance_metrics:type_name -> apollo.proto.registry.v1.ServiceInstanceMetrics
	10, // 7: apollo.proto.messages.v1.InstanceHeartbeatMessage.worker_instance_metrics:type_name -> apollo.proto.registry.v1.WorkerInstanceMetrics
